    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ url('/penulis/create') }}" class="btn btn-primary">Tambah</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ url('/penulis/edit/'.$item->id) }}" class="btn btn-primary btn-sm">edit</a>
                                    <a href="{{ url('/penulis/destroy/'.$item->id) }}" class="btn btn-danger btn-sm"
