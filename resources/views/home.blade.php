...
<div class="row">
  ...
  <div class="col-md-4">
    <figure  class="item-feature">
      ...
      <figcaption class="pt-3">
        <h5 class="title">Alip Love Mita</h5>
...
<header class="section-heading">
  <h3 class="section-title">Produk Alip</h3>
</header><!-- sect-heading -->
  ...
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      ...
      <figcaption class="info-wrap">
        <a href="#" class="title">{{$buku->judul}}</a>
        ...
        <div class="rating-wrap">
          ...
          <span class="label-rating text-muted"> 0 Can Aya Nu Meuli</span>
          <p>Kategori : <b>{{$buku->kategori->nama}}</b></p>
        </div>
